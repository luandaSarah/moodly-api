 ...
 */
final class Version20250723123517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE moodboard_like ADD CONSTRAINT FK_ECABEEFBA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE moodboard_like ADD CONSTRAINT FK_ECABEEFBADA9CECE FOREIGN KEY (moodboard_id) REFERENCES moodboard (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE moodboard_comment CHANGE enabled enabled TINYINT(1) DEFAULT 1 NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE moodboard_comment CHANGE enabled enabled TINYINT(1) NOT NULL
        SQL);
    }
}
